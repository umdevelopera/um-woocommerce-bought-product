...
You can install this plugin from the [ZIP archive](https://drive.google.com/file/d/1eOOnOf5tV3Xr5XYMt9UGmjvTrmTW9hXJ/view) as any other plugin. Follow [this instruction](https://wordpress.org/support/article/managing-plugins/#upload-via-wordpress-admin).
...
__Note:__ This filter is visible for administrators and roles that can edit other member accounts.
...
Go to _wp-admin > Ultimate Member > Dashboard_, find the **Bought products** widget and click the **Start** button to run the process. You'll see a progress bar below. Wait until the process will be done.
